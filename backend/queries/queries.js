...
const uploadMovement = (req, res, next) => {
  const {user_id, title, description, thumbnail, keyframes, steps} = req.body;

  const query = {
    text: `
    INSERT INTO movements (user_id, title, description, thumbnail, keyframes, steps)
      VALUES ($1, $2, $3, $4, $5, $6) RETURNING *;
    `,
    values: [user_id, title, description, thumbnail, keyframes, steps]
  };
